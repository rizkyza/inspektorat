      ...
      <?php echo form_open_multipart($action);?>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-body">
              <div class="form-group"><label>Subsubkode Keterangan</label>
                <?php echo form_input($subsubkode, $kodex->subsubkode);?>
              </div>
              <div class="form-group"><label>Keterangan</label>
                <?php echo form_input($keterangan,$kodex->keterangan);?>
              </div>
              <?php echo form_input($id_subsubkode,$kodex->id_subsubkode);?>
