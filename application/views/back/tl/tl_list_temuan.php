        ...
        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php echo anchor(site_url('admin/tl_temuan/update/'.$lhp->id_lhp),'<i class="glyphicon glyphicon-triangle-right"> Temuan</i>','title="Edit", class="btn btn-sm btn-primary"'); echo ' '; ?>
              </td>
            </tr>
            <?php endforeach;?>
          </tbody>
