      ...
      <?php echo form_open_multipart($action);?>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-body">
              <div class="form-group"><label>No Irban</label>
                <?php echo form_input($no_irban, $irban->no_irban);?>
              </div>
              <div class="form-group"><label>Irban</label>
                <?php echo form_input($nama_irban,$irban->nama_irban);?>
              </div>
              <div class="form-group"><label>Kepala Irban</label>
                <?php echo form_input($kepala_irban,$irban->kepala_irban);?>
              </div>
              <?php echo form_input($id_irban,$irban->id_irban);?>
