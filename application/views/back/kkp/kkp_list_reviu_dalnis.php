  ...
  <section class="content">
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">
        <label for="kode">Table PKP (Reviu KKP)</label>
      </div>
        ...
        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align:left"><?php echo $pkp->auditor ?></td>
              ...
              <td style="text-align:center">
                <?php echo anchor(site_url('admin/kkp/reviu/'.$pkp->id_pkp),'<i class="glyphicon glyphicon-pencil"></i>','title="Isi PKP", class="btn btn-sm btn-primary"'); echo ' '; ?>
              </td>
            </tr>
            <?php endforeach;?>
          </tbody>
