        ...
        <div class="col-md-12">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <label for="kode">Tabel Data Rekomendasi Temuan LHP</label>
            </div>
            ...
            <div class="box-body">
              ...
              <div class="panel-heading"><b>Tabel Temuan LHP</b></div>
                <div class="panel-body">
                  <div class="box-body">
                         ...
                         <table id="user_data" class="table table-bordered table-striped" cellspacing="0" width="100%">
                              <thead>
                                   <tr>
                                       <th style="text-align: center" width="10%">ID Temuan</th>
                                       <th style="text-align: center" width="13%">Kode Temuan</th>
                                       <th style="text-align: center" width="57%">Judul Temuan</th>
                                       <th style="text-align: center" width="15%">Nilai Temuan</th>
                                       <th style="text-align: center" width="5%">Verifikasi</th>
                                   </tr>
                              </thead>
                         </table>
                    </div>
 ...
 <script type="text/javascript" language="javascript" >
      $(document).ready(function(){
       ...
       var dataTable = $('#user_data').DataTable({
         ...
         //},
         "ajax":{
              url:"<?php echo base_url() . 'admin/vt_temuan/fetch_user'; ?>",
              data:{no_lhp:no_lhp},
              dataType:"JSON",
              type:"POST"
         },
