          ...
          <div class="row">
            ...
            <form method="get">
              ...
              <div class="form-group"><label>SOPD :</label>
                  <?php echo form_dropdown('',$get_combo_irban,'',$nama_irban_seo); ?>
              </div>
              ...
              <div class="form-group"><label>Tahun dipilih :</label>
                  <?php echo form_input($tahund, $tahun); ?>
              </div>
              <div class="form-group"><label>SOPD dipilih :</label>
                  <?php echo form_input($nama_irban_seo_d, $irban); ?>
              </div>
            </form>
        </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    $('#simpana').click(function(){
      var tahun = $("#tahund").val();
      var nama_irban_seo = $("#nama_irban_seo_d").val();
      alert(nama_irban_seo);
      window.location.href = "<?php echo base_url(); ?>laporan/lihattemuan/report_temuan_tahun_irban?tahund="+tahun+"&nama_irban_seo_d="+nama_irban_seo;
    });
  });
</script>
