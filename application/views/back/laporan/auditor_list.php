        ...
        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align:center">
              <?php
              echo anchor(site_url('laporan/Lihatauditor/view/'.$auditor->nip),'<i class="glyphicon glyphicon-print"></i> Lihat','title="Edit", class="btn btn-sm btn-primary" target="_blank"'); echo ' ';
