          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align:center">
                <?php echo anchor(site_url('laporan/laporanpkp/create/'.$spt->id_spt),'<i class="glyphicon glyphicon-print"></i> Lihat','title="Isi PKP", class="btn btn-sm btn-primary" target="_blank"'); echo ' '; ?>
              </td>
            </tr>
            <?php endforeach;?>
          </tbody>
...
<HTML>
    ...
    <TABLE WIDTH="25%">
    <TR>
    <TD ALIGN="left" WIDTH="20%"><IMG SRC="http://inspektorat.kalselprov.go.id/templates/shaper_helix3/images/presets/preset1/logo@2x.png" WIDTH="100%" HEIGHT="80"></TD>
    </TR>
    </TABLE>
    ...
    <BR>
      <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size:12px; font-family:chelvetica;">
        <thead>
          <tr>
            <span style="font-size:12px"><th style="text-align: center; border:1px solid #000;">No Langkah Kerja</th></span>
            <span style="font-size:12px"><th style="text-align: center; border:1px solid #000;">langkah Kerja</th></span>
            <span style="font-size:12px"><th style="text-align: center; border:1px solid #000;">Dilaksanakan oleh</th></span>
            <span style="font-size:12px"><th style="text-align: center; border:1px solid #000;">Waktu Pemeriksaan</th></span>
            <span style="font-size:12px"><th style="text-align: center; border:1px solid #000;">No KKP</th></span>
            <span style="font-size:12px"><th style="text-align: center; border:1px solid #000;">Jumlah LHP yang dikehendaki</th></span>
            <span style="font-size:12px"><th style="text-align: center; border:1px solid #000;">Ket</th></span>
          </tr>
        </thead>
        <tbody>

          <tr>
            <span style="font-size:12px"><td style="text-align:center; border:1px solid #000;">a</td></span>
            <span style="font-size:12px"><td style="text-align:left; border:1px solid #000;">b</td></span>
            <span style="font-size:12px"><td style="text-align:left; border:1px solid #000;">c</td></span>
            <span style="font-size:12px"><td style="text-align:left; border:1px solid #000;">d</td></span>
            <span style="font-size:12px"><td style="text-align:left; border:1px solid #000;">e</td></span>
            <span style="font-size:12px"><td style="text-align:left; border:1px solid #000;">f</td></span>
            <span style="font-size:12px"><td style="text-align:left; border:1px solid #000;">g</td></span>
          </tr>
