          ...
          <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size:12px; font-family:chelvetica;">
            <thead>
              <tr>
                ...
                <span style="font-size:12px"><th style="text-align: center; border:1px solid #000;">No SPT</th></span>
                <span style="font-size:12px"><th style="text-align: center; border:1px solid #000;">Tanggal LHP</th></span>
                <span style="font-size:12px"><th style="text-align: center; border:1px solid #000;">Uploader</th></span>
                <span style="font-size:12px"><th style="text-align: center; border:1px solid #000;">Waktu Upload</th></span>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                <span style="font-size:12px"><td style="text-align:left; border:1px solid #000;"><?php echo $lhp->no_spt ?></td></span>
                <span style="font-size:12px"><td style="text-align:left; border:1px solid #000;"><?php echo $lhp->tanggal_lhp ?></td></span>
                <span style="font-size:12px"><td style="text-align:left; border:1px solid #000;"><?php echo $lhp->uploader ?></td></span>
                <span style="font-size:12px"><td style="text-align:left; border:1px solid #000;"><?php echo $lhp->time_uploader ?></td></span>
              </tr>
              <?php endforeach;?>
            </tbody>
          </table>
