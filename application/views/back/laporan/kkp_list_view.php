          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align:center">
                <?php echo anchor(site_url('laporan/lihatkkp/create/'.$pkp->id_pkp),'<i class="glyphicon glyphicon-print"></i>  Lihat','title="Isi PKP", class="btn btn-sm btn-primary" target="_blank"'); echo ' '; ?>
              </td>
            </tr>
            <?php endforeach;?>
          </tbody>
