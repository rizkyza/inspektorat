        ...
        <div class="col-md-12">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <label for="kode">Form Update Tim Auditor</label>
            </div>
            <div class="box-body">
              <div class="panel panel-primary">
              ...
              <div class="panel-heading"><b>Entry ketua dan anggota auditor</b></div>
                <div class="panel-body">
                  <div class="box-body">
                    ...
                    <?php } else if($this->ion_auth->is_auditor() && $nip_ketuatim == $this->session->userdata('nip')){?>
                       <button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-info">Tambah Auditor</button>
                    <?php } ?>

                    <a href="<?php echo base_url('admin/sptauditor/report_tim_auditor/'.$spt->id_spt);?>" target="_blank" class="btn btn-primary"><i class="fa fa-file-pdf-o"></i> Lihat Data Tim Auditor</a>
                         <br /><br />
           ...
           <form method="post" id="user_form">
                <div class="modal-content">
                     ...
                     <div class="modal-body">
                       <div class="form-group"><label>Jabatan <a class="text-warning">*</a></label>
      ...
      $(document).ready(function(){
       ...
       $("#jabatan").on("change", function() {
         ...
         if (jabatan == 'Penanggung Jawab') {
           $.ajax({
               url: '<?php echo base_url() . 'admin/sptauditor/fetch_single_penanggungjawab' ?>',
               method:"POST",
               ...
               success:function(data)
               {
                    ...
                    $('#nip').val(data.nip);
                    $('#foto').val(data.foto);
                    $('#nipcombo').attr("disabled", "disabled");
                    $('#nipcombo').val("Pilih Auditor");
               }

           });
         } else {
           $('#nipcombo').removeAttr("disabled");
         }
       });
            ...
            if(nip != '' && nama != '')
            {
                 $.ajax({
                      ...
                      success:function(data)
                      {
                           ...
                           swal('Data '+nama+' berhasil ditambah ' );
                      },
