		...
		<div class="col-md-8">
			...
			<div class="row">
			  ...
			  <div class="col-sm-6 col-md-6">
			    <div class="thumbnail">
			      <?php 
			      if(empty($berita_arsip->userfile)) {echo "<img src='".base_url()."assets/images/no_image_thumb.png' width='400' height='200'>";}  
			      else { echo " <img src='".base_url()."assets/images/berita/".$berita_arsip->userfile.'_thumb'.$berita_arsip->userfile_type."'> ";}
			      ?>
			      <div align="right">
