...
class Lihatpkpt extends CI_Controller
{
  ...
  public function laporan_pkpt($tahun)
  {
    $this->data['title'] = "Laporan PKPT";
    //$tahun = $this->input->get('tahun');
    $this->data['pkpt_data'] = $this->Pkpt_calendar_model->get_all_data_by_tahun($tahun);
    $this->data['tahun'] = $tahun;
    $this->load->view('back/laporan/laporan_pkpt', $this->data);
  }
  ...
  public function index()
  {
    ...
    $this->load->view('back/laporan/laporan_pilih_tahun_pkpt', $this->data);
  }
