...
class Lihatkkp extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->load->view('back/laporan/kkp_list_view', $this->data);
  }
  ...
  public function create($id_pkp)
  {
    ...
    $this->data['kkp_data'] = $this->Kkp_model->get_data_kkp($id_pkp);
    $nospt = $this->data['pkp']->no_spt;
    $this->data['irban'] = $this->Spt_model->get_irban_by_nospt($nospt);
      if ($row)
      {
        ...
        $this->load->view('back/laporan/kkp_view', $this->data);
      }
      else
      {
        $this->session->set_flashdata('message', 'Data tidak ditemukan');
        redirect(site_url('laporan/lihatpkp'));
      }
  }
