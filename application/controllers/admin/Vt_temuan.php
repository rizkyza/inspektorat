...
class Vt_temuan extends CI_Controller
{
  ...
  {
    $this->data['title'] = "Data LHP Verifikasi Temuan";

    $this->data['lhp_data'] = $this->Vt_model->get_all_by_irban_ketuatim();
  ...
  public function update($id)
  {
    ...
    if ($row)
    {
      ...
      $this->load->view('back/vt/vt_edit_temuan', $this->data);
    }
      else
      {
  ...
  public function update_action()
    ...
    function fetch_user(){
         ...
         foreach($fetch_data as $row)
         {
              ...
              $sub_array[] = '<a href="'.base_url().'admin/vt_temuan_rekomendasi/update/'.$row->id_temuan.'" type="button" name="verifikasi" id="'.$row->id_temuan.'" class="btn btn-primary btn-sm verifikasi"><i class="glyphicon glyphicon-triangle-right"> Verifikasi</i></button>';
              $data[] = $sub_array;
         }
         $output = array(
