...
class Pkp extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->load->view('back/pkp/pkp_spt_list', $this->data);
  }
  ...
  public function create($id_spt)
  {
    ...
    $this->data['nama'] = $this->Ion_auth_model->get_username_by_username($username);
      ...
      if ($row)
      {
        ...
        $this->data['action']         = site_url('admin/pkp/create_action');
        ...
        $this->load->view('back/pkp/pkp_add', $this->data);
      }
      else
      {
  ...
  function fetch_user(){
       ...
       foreach($fetch_data as $row)
       {
            ...
            $sub_array[] = '<button type="button" name="update" id="'.$row->id_pkp.'" class="btn btn-warning btn-xs update">Update</button>';
            $sub_array[] = '<button type="button" name="delete" id="'.$row->id_pkp.'" class="btn btn-danger btn-xs delete">Delete</button>';
            $data[] = $sub_array;
       }
       $output = array(
