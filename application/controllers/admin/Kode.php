...
class Kode extends CI_Controller
{
  ...
  {
    $this->data['title'] = "KODE TEMUAN PEMERIKSAAN";

    $this->data['kode_data'] = $this->Kode_model->get_all();
    $this->load->view('back/kode/kode_list', $this->data);
  }

  public function create()
  {
    $this->data['title']          = 'Tambah Kode Baru';
    $this->data['action']         = site_url('admin/kode/create_action');
    ...
    $this->load->view('back/kode/kode_add', $this->data);
  }
  ...
  {
    $row = $this->Kode_model->get_by_id($id);
    $this->data['kodex'] = $this->Kode_model->get_by_id($id);

    if ($row)
    {
      $this->data['title']          = 'Update Kode';
      $this->data['action']         = site_url('admin/kode/update_action');
      ...
      $this->load->view('back/kode/kode_edit', $this->data);
    }
      else
      {
  ...
  public function update_action()
    {
      ...
      if ($this->form_validation->run() == FALSE)
      {
        ...
        else
        {
          ...
          $this->Kode_model->update($this->input->post('id_kode'), $data);
